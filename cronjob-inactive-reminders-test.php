<?php
/**
 * Cronjob Script für Inaktivitäts-Erinnerungs-E-Mails - TEST
...
putenv('APP_ENV=production'); // Auch Test nutzt production, nur anderer Pfad
...
try {
    echo "[" . date('Y-m-d H:i:s') . "] Starte Inaktivitäts-Erinnerungs-Check (TEST)...\n";
