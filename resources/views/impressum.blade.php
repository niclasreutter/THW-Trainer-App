...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-8">Impressum</h1>
        
        <div class="space-y-6 text-gray-700">
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Angaben gemäß § 5 TMG:</h2>
                <div class="ml-4">
                    <p>Niclas Reutter</p>
                    <p>Ringstraße 10</p>
                    <p>88719 Stetten</p>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Kontakt:</h2>
                <div class="ml-4">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Haftung für Inhalte:</h2>
                <div class="ml-4">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Haftung für Links:</h2>
                <div class="ml-4">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Urheberrecht:</h2>
                <div class="ml-4">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-800 mb-3">Datenschutz & Cookies:</h2>
                <div class="ml-4">
                    ...
                    <p>Weitere Informationen zum Datenschutz, zur Datenspeicherung und zu deinen Rechten als Nutzer findest du in der <a href="{{ route('datenschutz') }}" class="text-blue-600 hover:text-blue-800 underline">Datenschutzerklärung</a>.</p>
                </div>
            </section>
        </div>
    </div>
