@extends('layouts.app')
@section('title', 'Achievement bearbeiten - THW Trainer Admin')
...
<div class="dashboard-wrapper">
    <div class="dashboard-container">
        <div class="dashboard-header">
            <h1 class="dashboard-greeting">✏️ <span>Achievement bearbeiten</span></h1>
            <p class="dashboard-subtitle">{{ $achievement->title }}</p>
        </div>
        ...
        <div class="info-badge">
            Dieses Achievement wurde von {{ $achievement->users()->count() }} Nutzern freigeschaltet.
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('admin.achievements.update', $achievement->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="trigger_type" name="trigger_type" required>
                        @foreach($triggerTypes as $key => $label)
                            <option value="{{ $key }}" {{ old('trigger_type', $achievement->trigger_type) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                @php
                    ...
                    $triggerSection = $triggerConfig['section'] ?? '';
                @endphp
                ...
                <div id="trigger-config-value" class="trigger-config">
                    ...
                    <input type="number"
                           ...
                           id="trigger_value"
                           name="trigger_value"
                           value="{{ old('trigger_value', $triggerValue) }}"
                           min="0">
                ...
                <div id="trigger-config-section" class="trigger-config">
                    ...
                    <input type="number"
                           ...
                           value="{{ old('trigger_section', $triggerSection) }}"
                           min="1"
                           max="10">
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                           ...
                           id="sort_order"
                           name="sort_order"
                           value="{{ old('sort_order', $achievement->sort_order) }}"
                           min="0">
