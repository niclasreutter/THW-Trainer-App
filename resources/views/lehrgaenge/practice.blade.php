        ...
        <div class="question-card">
            ...
            <form method="POST" action="{{ route('lehrgaenge.submit', $question->lehrgang_slug) }}" id="practiceForm">
                ...
                <div class="submit-button-wrapper">
                    ...
                    @else
                        @if(isset($currentSectionNr) && $currentSectionNr)
                        <a href="{{ route('lehrgaenge.practice-section', ['slug' => $question->lehrgang_slug, 'sectionNr' => $currentSectionNr]) }}" class="btn-primary w-full py-4 text-base text-center block">
                            Nächste Frage
                        </a>
                        @else
                        <a href="{{ route('lehrgaenge.practice', $question->lehrgang_slug) }}" class="btn-primary w-full py-4 text-base text-center block">
                            Nächste Frage
                        </a>
                        @endif
                    @endif
