...
<div class="dash-container">
    ...
    <div class="dash-grid">
        ...
        <div class="space-y-4">
            ...
            @if(!$examCountdown)
            <a href="{{ route('einstellungen') }}" class="glass lg:hidden" data-tour-step="countdown" style="display:block;text-decoration:none;padding:0.875rem 1rem;">
        ...
        <div class="hidden lg:block space-y-4">
            ...
            @else
            <a href="{{ route('einstellungen') }}" class="countdown-widget" data-tour-step="countdown" style="display:block;text-decoration:none;">
