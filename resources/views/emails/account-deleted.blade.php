...
<head>
    ...
    <title>Account gelöscht - THW Trainer</title>
</head>
    ...
    <div style="background:#f0f2f5;padding:32px 16px;">
        <div style="max-width:600px;margin:0 auto;">
            ...
            <div style="background:#ffffff;padding:28px 24px;border-left:3px solid #00337F;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                ...
                <div style="font-size:10px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#64748b;margin-bottom:6px;">Account gelöscht</div>
                <div style="font-size:20px;font-weight:800;color:#0f172a;margin-bottom:16px;">Dein Account wurde gelöscht</div>

                <p style="margin:0 0 16px 0;font-size:13px;color:#475569;line-height:1.6;">Hallo <strong>{{ $user->name }}</strong>,</p>
                <p style="margin:0 0 16px 0;font-size:13px;color:#475569;line-height:1.6;">dein THW-Trainer Account (erstellt am <strong>{{ $accountCreatedAt }}</strong>) wurde aufgrund fehlender E-Mail-Bestätigung automatisch gelöscht.</p>

                <!-- Fehler-Box: Löschbestätigung -->
                <div style="background:#fef2f2;border-radius:8px;padding:14px 16px;margin-bottom:16px;border-left:3px solid #ef4444;">
                    <p style="margin:0;font-size:13px;color:#991b1b;line-height:1.6;"><strong>Dein Account und alle damit verbundenen Daten wurden permanent entfernt.</strong></p>
                </div>

                <p style="margin:0 0 16px 0;font-size:13px;color:#475569;line-height:1.6;">Das passiert, wenn ein Account länger als 9 Tage ohne E-Mail-Bestätigung existiert.</p>

                <!-- Gründe -->
                <div style="background:#f0f4ff;border-radius:8px;padding:14px 16px;margin-bottom:16px;border-left:3px solid #3b82f6;">
                    <p style="margin:0 0 8px 0;font-size:13px;font-weight:700;color:#1e3a5f;">Warum wurde der Account gelöscht?</p>
                ...
                <div style="text-align:center;margin:24px 0;">
                    <a href="https://{{ config('domains.app') }}/register" style="background:linear-gradient(135deg,#00337F,#0055cc);color:#fff;padding:12px 32px;border-radius:0.5rem;text-decoration:none;font-weight:700;font-size:13px;display:inline-block;box-shadow:0 4px 15px rgba(0,51,127,0.3);">Neuen Account erstellen</a>
                </div>

                <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6;">Ein neuer Account startet mit leeren Statistiken. Alle bisherigen Lernfortschritte und Einstellungen sind nicht mehr verfügbar.</p>
