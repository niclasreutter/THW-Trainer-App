        ...
        <div style="max-width:600px;margin:0 auto;">
            ...
            <div style="background:#ffffff;padding:28px 24px;border-left:3px solid #00337F;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                ...
                <div style="text-align:center;margin:24px 0 8px;">
                    <a href="https://thw-trainer.de/practice-menu" style="background:linear-gradient(135deg,#00337F,#0055cc);color:#fff;padding:12px 32px;border-radius:0.5rem;text-decoration:none;font-weight:700;font-size:13px;display:inline-block;box-shadow:0 4px 15px rgba(0,51,127,0.3);">Jetzt weiterlernen</a>
                </div>
