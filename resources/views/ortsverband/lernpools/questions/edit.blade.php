...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <h1 class="text-4xl font-bold text-gray-900 mt-4 mb-8">Frage bearbeiten</h1>

    <div class="bg-white rounded-lg shadow p-8">
        <form action="{{ route('ortsverband.lernpools.questions.update', [$ortsverband, $lernpool, $question]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="lernabschnitt" id="lernabschnitt" value="{{ old('lernabschnitt', $question->lernabschnitt) }}" 
                ...
                <div>
                    ...
                    <input type="number" name="nummer" id="nummer" value="{{ old('nummer', $question->nummer) }}" 
            ...
            <div class="mb-6">
                ...
                <textarea name="frage" id="frage" rows="3" 
                          ...
                          required>{{ old('frage', $question->frage) }}</textarea>
                @error('frage')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="antwort_a" id="antwort_a" value="{{ old('antwort_a', $question->antwort_a) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="antwort_b" id="antwort_b" value="{{ old('antwort_b', $question->antwort_b) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="antwort_c" id="antwort_c" value="{{ old('antwort_c', $question->antwort_c) }}" 
            ...
            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                ...
                <select name="loesung" id="loesung" 
                    ...
                    <option value="a" {{ old('loesung', $question->loesung) === 'a' ? 'selected' : '' }}>A</option>
                    <option value="b" {{ old('loesung', $question->loesung) === 'b' ? 'selected' : '' }}>B</option>
                    <option value="c" {{ old('loesung', $question->loesung) === 'c' ? 'selected' : '' }}>C</option>
                </select>
                @error('loesung')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
