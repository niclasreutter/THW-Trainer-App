...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <h1 class="text-4xl font-bold text-gray-900 mt-4 mb-8">Neuer Lernpool</h1>
            ...
            <div class="mb-6">
                <label for="is_active" class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" 
                           {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 rounded">
                    <span class="ml-3 text-sm font-medium text-gray-900">Sofort aktivieren</span>
                </label>
            </div>
