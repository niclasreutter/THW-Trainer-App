...
<div class="max-w-xl mx-auto mt-2 sm:mt-4 p-3 sm:p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
    ...
    @if($question)
        ...
        <form method="POST" action="{{ route('practice.submit') }}">
                ...
                <div class="mb-0">
                    ...
                    <div class="flex flex-col gap-2.5 sm:gap-2">
                        @foreach($answers as $index => $answer)
                            ...
                            @endphp
                            <label class="inline-flex items-start p-2.5 sm:p-2 rounded-lg hover:bg-gray-50 transition-all duration-200 cursor-pointer">
                                @if(isset($isCorrect))
                                    @if($isCorrectAnswer)
            ...
            @if(!isset($isCorrect))
                <button type="submit" id="submitBtn" class="w-full text-center font-bold border-none cursor-pointer transition-all duration-300 rounded-lg py-3 px-4 text-sm" 
                ...
                @if($showTopGamification)
                    <div class="mt-3 animate-fade-in">
                        <div class="flex items-center gap-1 px-3 py-2 rounded-lg text-sm"
                            ...
                            <span style="color: #16a34a;">+{{ $topPointsAwarded }} <span class="hidden sm:inline">Punkte</span><span class="sm:hidden">P</span></span>
            ...
            @elseif(isset($isCorrect) && $isCorrect)
                <a href="{{ route('practice.index') }}" class="block w-full text-center font-bold no-underline transition-all duration-300 rounded-lg py-3 px-4 text-sm"
                   style="background-color: #1e3a8a; color: #fbbf24; box-shadow: 0 0 20px rgba(30, 58, 138, 0.4), 0 0 40px rgba(30, 58, 138, 0.2);"
                ...
                @if($showGamification)
                    <div class="mt-3 animate-fade-in">
                        <div class="flex items-center gap-1 px-3 py-2 rounded-lg text-sm"
                            ...
                            <span style="color: #16a34a;">+{{ $pointsAwarded }} <span class="hidden sm:inline">Punkte</span><span class="sm:hidden">P</span></span>
            ...
            @elseif(isset($isCorrect) && !$isCorrect)
                <a href="{{ route('practice.index', ['skip_id' => $question->id]) }}" class="block w-full text-center font-bold no-underline transition-all duration-300 rounded-lg py-3 px-4 text-sm"
                   style="background-color: #1e3a8a; color: #fbbf24; box-shadow: 0 0 20px rgba(30, 58, 138, 0.4), 0 0 40px rgba(30, 58, 138, 0.2);"
                   onmouseover="this.style.backgroundColor='#fbbf24'; this.style.color='#1e3a8a'; this.style.transform='scale(1.02)'; this.style.boxShadow='0 0 25px rgba(251, 191, 36, 0.5), 0 0 50px rgba(251, 191, 36, 0.3)';"
                   onmouseout="this.style.backgroundColor='#1e3a8a'; this.style.color='#fbbf24'; this.style.transform='scale(1)'; this.style.boxShadow='0 0 20px rgba(30, 58, 138, 0.4), 0 0 40px rgba(30, 58, 138, 0.2)';">Nächste Frage</a>
