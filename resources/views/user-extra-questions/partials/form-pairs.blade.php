...
<div x-data="{
    ...
    <div class="zf-form-card">
        ...
        <p class="zf-help" style="margin: 0 0 0.75rem;">
            Trage je Paar einen Begriff links und den dazu passenden rechts ein.
            Im Spiel werden die rechten Begriffe gemischt; der Nutzer muss die richtigen Paare wieder zusammensetzen.
        </p>
        ...
        <template x-for="(pair, i) in pairs" :key="i">
            <div class="zf-pair zf-pair--inline">
                ...
                <input type="text" class="zf-input"
                       ...
                       placeholder="Linke Seite" required maxlength="255">
                ...
                <input type="text" class="zf-input"
                       ...
                       placeholder="Rechte Seite" required maxlength="255">
            </div>
        </template>
