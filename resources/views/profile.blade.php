...
<style>
    ...
    .bento > .card-training      { grid-column: span 12; }
    ...
    .tp-summary__value { font-size: 1.25rem; font-weight: 700; color: var(--text-primary); }
    .tp-summary__bar {
        height: 4px;
        border-radius: 999px;
...
<div class="dash-container">
    ...
    <div class="bento">
        ...
        {{-- ══════════════════════════════════════════
             AUSBILDUNGSFORTSCHRITT (span 12) — Issue #442
        ══════════════════════════════════════════ --}}
        <div class="glass card-training card" x-data="trainingProgress({
            ...
            sectionUrl: @js(route('profile.training-progress.section'))
        })">
            <div class="card-head">
                <span class="section-label">Ausbildungsfortschritt</span>
                <span class="card-head__hint" x-text="overview.done + ' / ' + overview.total + ' erledigt'"></span>
            </div>
