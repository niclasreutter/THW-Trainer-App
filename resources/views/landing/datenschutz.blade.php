    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
        ...
        <div class="space-y-8 text-slate-600">
            ...
            <div class="mt-8 pt-6 border-t border-slate-200">
                <p class="text-sm text-slate-500">Stand: 22. Oktober 2025</p>
                <p class="text-xs text-slate-400 mt-2">Letzte Änderung: Hinzufügung des öffentlichen Leaderboards (Opt-In)</p>
            </div>
        </div>
    </div>
</div>
