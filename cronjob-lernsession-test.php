<?php
/**
 * Cronjob Script für Lernsession-Lifecycle - TEST
 *
 * LOGIK:
 ...
 *
 */
// CRONJOB: alle 5 Minuten - */5 * * * * /usr/bin/php /path/to/cronjob-lernsession-test.php
...
try {
    echo "[" . date('Y-m-d H:i:s') . "] Starte Lernsession-Lifecycle (TEST)...\n";
